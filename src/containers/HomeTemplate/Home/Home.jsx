...
<section className="hero">
  <div className="container">
    <div className="row">
      ...
      <div className="col-lg-9">
        ...
        <div className="hero__item set-bg" data-setbg="img/hero/banner.jpg" style={{  
  ...
  <section className="categories">
    ...
    backgroundImage: "url(" + "assets/img/categories/cat-1.jpg" + ")"
          ...
          <div className="col-lg-3">
            <div className="categories__item set-bg"  style={{  
    backgroundImage: "url(" + "assets/img/categories/cat-2.jpg" + ")"
          ...
          <div className="col-lg-3">
            ...
            style={{  
              backgroundImage: "url(" + "assets/img/categories/cat-3.jpg" + ")"
            }}
          ...
          <div className="col-lg-3">
            <div className="categories__item set-bg"
             style={{  
              backgroundImage: "url(" + "assets/img/categories/cat-4.jpg" + ")"
            }}
          ...
          <div className="col-lg-3">
            <div className="categories__item set-bg"
                style={{  
                  backgroundImage: "url(" + "assets/img/categories/cat-5.jpg" + ")"
                }}
  ...
  <section className="featured spad">
    ...
    backgroundImage: "url(" + "assets/img/featured/feature-1.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
          <div className="featured__item">
            ...
            style={{  
              backgroundImage: "url(" + "assets/img/featured/feature-2.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
          <div className="featured__item">
            <div className="featured__item__pic set-bg"
               style={{  
                backgroundImage: "url(" + "assets/img/featured/feature-3.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix fastfood oranges">
          <div className="featured__item">
            <div className="featured__item__pic set-bg" 
              style={{  
                backgroundImage: "url(" + "assets/img/featured/feature-4.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
          <div className="featured__item">
            <div className="featured__item__pic set-bg"
              style={{  
                backgroundImage: "url(" + "assets/img/featured/feature-5.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix oranges fastfood">
          <div className="featured__item">
            <div className="featured__item__pic set-bg"
              style={{  
                backgroundImage: "url(" + "assets/img/featured/feature-6.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
          <div className="featured__item">
            <div className="featured__item__pic set-bg"
              style={{  
                backgroundImage: "url(" + "assets/img/featured/feature-7.jpg" + ")"
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 mix fastfood vegetables">
          <div className="featured__item">
            <div className="featured__item__pic set-bg"
              style={{  
                backgroundImage: "url(" + "assets/img/featured/feature-8.jpg" + ")"
