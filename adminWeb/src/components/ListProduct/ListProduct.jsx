...
function ListProduct() {
  ...
  useEffect(() => {
    const initData = async () => {
      const response = await doGet(`product/admin/listProducts?searchValue=all`);
      ...
      <div className="page-header">
        <div className="row align-items-center mb-3">
          <div className="col-sm mb-2 mb-sm-0">
            <h1 className="page-header-title">Products <span className="badge badge-soft-dark ml-2">49</span></h1>
            <div className="mt-2">
              ...
              <a className="text-body" href="javascript:;" data-toggle="modal" data-target="#importProductsModal">
            ...
            <div className="col-auto">
              ...
              <div className="hs-unfold">
                <a className="js-hs-unfold-invoker btn btn-white" href="javascript:;" data-hs-unfold-options="{
                  ...
                  <i className="tio-table mr-1" /> Columns <span className="badge badge-soft-dark rounded-circle ml-1">6</span>
                </a>
         ...
         return  <tr key={index}>
                ...
                <td className="table-column-pl-0">
                  <a className="media align-items-center" >
                    <img className="avatar avatar-lg mr-3" src={`http://localhost:3001/assets/img/secondhand/accessories/${item.imageEntity[0].url}`} alt="" style={{width:"50px",height:"50px"}}  />
