              ...
              <div className="row">
                ...
                <div className="col-sm-4">
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group input-group-merge">
                      <input type="text" className="form-control" name="sizeName" id="sizeLabel" placeholder="M" aria-label="M" defaultValue="S" />
                    </div>
                  </div>
                  {/* End Form Group */}
                </div>
                <div className="col-sm-4">
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group input-group-merge">
                      <input type="text" className="form-control" name="sizeName" id="colorLabel" placeholder="Đen" aria-label="Đen" defaultValue="Trắng" />
                    </div>
                  </div>
                  {/* End Form Group */}
                </div>
        ...
        <div className="col-lg-4">
          ...
          <div className="card mb-3 mb-lg-5">
            ...
            <div className="card-body">
              ...
              <div className="form-group">
                {/* Price */}
                <label htmlFor="priceSaleNameLabel" className="input-label">Giá bán (VND)
                </label>
                <div className="input-group">
                  <input type="number" className="form-control" name="priceSaleName" id="priceSaleNameLabel" placeholder={0.00} aria-label={0.00} defaultValue={500000} />
                </div>
                {/* End Price */}
                <br />
                {/* Price Sale*/}
                ...
                <div className="input-group">
                  <input type="number" className="form-control" name="priceName" id="priceNameLabel" placeholder={0.00} aria-label={0.00} defaultValue={45000} />
                </div>
                {/* End Price Sale*/}
              </div>
              {/* End Form Group */}
